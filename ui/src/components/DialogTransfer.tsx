...
export const showTransferDialog = (tokenId: bigint) => {
    setTokenId(tokenId)
    setOpen(true)
}

export default function DialogTransfer() {
        ...
        <Show when={isOpen()}>
            <div class="fixed top-0 left-0 w-full min-h-screen flex flex-col items-center justify-center bg-black/20 backdrop-blur-sm">
                <div class="p-4 bg-slate-800 rounded-3xl w-full max-w-xs flex flex-col gap-2.5">
                    <p class="font-semibold text-2xl text-center">Transfer {token().symbol}</p>
